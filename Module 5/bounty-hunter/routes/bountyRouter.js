...
bountyRouter.route("/")
    ...
    .post((req, res, next) => {
        ...
        return res.status(201).send(`${newBounty.firstName} ${newBounty.lastName} has been added to the registry, wanted ${newBounty.living ? "Alive" : "Dead"}.`)
    })
    ...
    .put((req, res, next) =>{
        Bounty.findOneAndUpdate(
            ...
            (err, updatedBounty) => {
                ...
                return res.status(200).send(`${updatedBounty.firstName} bounty updated.`)
            })
    })
    .delete((req, res, next) => {
